...
const mockExposureInfo: ExposureInfo = {
  ...
  "files": [
      ...
      [
          "exposure/alphafold_NCE2.png",
          true
      ],
      [
          "exposure/exposure_frontpage.rst",
          false
      ],
      [
          "units_and_constants/constants_BG.cellml",
          false
      ],
      [
          "units_and_constants/ion_valency.cellml",
          false
      ],
      [
          "units_and_constants/units_BG.cellml",
          false
      ]
  ],
  "workspace": {
